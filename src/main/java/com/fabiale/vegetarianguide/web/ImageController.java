...
public class ImageController {
	...
	@Secured("ROLE_USER")
	@RequestMapping(value = "/restaurant/image/save/{id}", method = RequestMethod.POST)
	public String save(@PathVariable("id") Integer id, @ModelAttribute("image") Image image, @RequestParam("file") MultipartFile file) throws IOException, DropboxException {
...
//		}
		imageService.upload(image, file.getBytes());

		...
		Session session = Session.getDefaultInstance(props,
			new javax.mail.Authenticator() {
				protected PasswordAuthentication getPasswordAuthentication() {
					return new PasswordAuthentication("fabyanjos@gmail.com","angel&pikachu16");
				}
			});
...
//			message.setFrom(new InternetAddress("from@no-spam.com"));
			message.setRecipients(Message.RecipientType.TO,
					InternetAddress.parse("fabyanjos@gmail.com"));
			message.setSubject("Testing Subject");
			message.setContent("<b>Dear Mail Crawler,</b>" +
					"<br/><br/> No spam to my email, please!", "text/html; charset=utf-8");
